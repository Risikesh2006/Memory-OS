...
function CapsuleDetailPageContent({ params }) {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex items-center gap-7">
            {[
              ...
              { label: 'Collections',  href: '/dashboard/capsules',  active: true },
      ...
      <main className="relative">
        <CapsuleDetail capsuleId={params.id} />
      </main>
    </div>
  );
}
...
export default function CapsuleDetailPage({ params }) {
  return <CapsuleDetailPageContent params={params} />;
}
